...
export type Database = {
  public: {
    Tables: {
      ...
      team_invites: { Row: { id: string; team_id: string | null; inviter_id: string; invitee_email: string; status: string; created_at: string }; Insert: { id?: string; team_id?: string | null; inviter_id: string; invitee_email: string; status?: string; created_at?: string }; Update: { id?: string; team_id?: string | null; inviter_id?: string; invitee_email?: string; status?: string; created_at?: string }; Relationships: [] }
    }
    Views: { [_ in never]: never }
    Functions: { accept_team_invite: { Args: { p_invite_id: string }; Returns: Database['public']['Tables']['teams']['Row'] }; initialize_profile: { Args: { p_user_id: string; p_timezone: string }; Returns: undefined }; update_presence: { Args: Record<PropertyKey, never>; Returns: undefined } }
